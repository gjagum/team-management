...
const permissions: Omit<any, "id" | "createdAt">[] = [
  ...
  // Overtime management
  {
    ...
    description: "Create overtime records",
    resource: "overtime",
    action: "create",
  },
  {
  ...
  },
  {
    ...
    description: "Update overtime records",
    resource: "overtime",
    action: "update",
  },
  {
    name: "overtime.delete",
    description: "Delete overtime records",
    resource: "overtime",
    action: "delete",
  },
  {
    name: "overtime.approve",
    description: "Approve or reject overtime records",
    resource: "overtime",
    action: "approve",
  },
  ...
  // Schedule management
  {
    ...
    description: "Create employee schedules",
    resource: "schedules",
    action: "create",
  },
  {
    name: "schedules.read",
    description: "View employee schedules",
    resource: "schedules",
    action: "read",
  },
  {
    name: "schedules.update",
    description: "Update employee schedules",
    resource: "schedules",
    action: "update",
  },
  {
    name: "schedules.delete",
    description: "Delete employee schedules",
    resource: "schedules",
    action: "delete",
  },
...
async function seed() {
  ...
  const defaultSettings = [
    // Company
    {
      ...
      category: "company",
      label: "Company Name",
      description: "Your organization name displayed across the application",
      dataType: "string",
    },
    {
      ...
      category: "company",
      label: "Timezone",
      description: "Default timezone for scheduling and reporting",
      dataType: "string",
    },
    {
      ...
      category: "company",
      label: "Currency",
      description: "Currency used for salary and overtime calculations",
      dataType: "string",
    },
    {
      key: "company.work_hours_per_day",
      value: "8",
      category: "company",
    ...
    // Leave
    {
      key: "leave.annual_allowance",
      value: "15",
      category: "leave",
      label: "Annual Leave Allowance",
      description:
        "Default number of paid leave days per year for new employees",
      dataType: "number",
    },
    {
      key: "leave.types",
      value: "Vacation,Sick,Personal,Emergency,Maternity,Paternity,Bereavement",
      category: "leave",
      label: "Leave Types",
    ...
    },
    {
      ...
      value: "false",
      category: "leave",
      label: "Carry-Over Enabled",
      description: "Allow unused leave days to carry over to the next year",
      dataType: "boolean",
    },
    {
      ...
      description: "Maximum number of unused leave days that can carry over",
      dataType: "number",
    },
    {
      ...
      description: "Require manager/admin approval for leave requests",
      dataType: "boolean",
    },
    {
      key: "leave.min_advance_days",
      value: "3",
      category: "leave",
      label: "Minimum Advance Notice (days)",
      description:
        "Minimum number of days in advance a leave request must be submitted",
      dataType: "number",
    },

    // Schedule
    {
      key: "schedule.default_shift",
      value: "MORNING",
      category: "schedule",
      label: "Default Shift Type",
      description: "Default shift assigned to new employees",
      dataType: "string",
    },
    {
      key: "schedule.work_week_start",
      value: "1",
      category: "schedule",
      label: "Work Week Starts On",
      description:
        "Day the work week starts (0=Sunday, 1=Monday ... 6=Saturday)",
      dataType: "number",
    },
    {
      key: "schedule.default_break_minutes",
      value: "60",
      category: "schedule",
      label: "Default Break (minutes)",
      description: "Default break duration in minutes per shift",
      dataType: "number",
    },
    {
      key: "schedule.auto_populate_on_hire",
      value: "true",
      category: "schedule",
      label: "Auto-Populate on Hire",
      description:
        "Automatically create default schedule when a new employee is hired",
      dataType: "boolean",
    },

    // Overtime
    {
      key: "overtime.max_monthly_hours",
      value: "40",
      category: "overtime",
      label: "Max Monthly OT Hours",
      description: "Maximum allowed overtime hours per employee per month",
      dataType: "number",
    },
    {
      key: "overtime.rate_multiplier",
      value: "1.5",
      category: "overtime",
      label: "OT Rate Multiplier",
      description: "Overtime pay multiplier (e.5 = time-and-a-half)",
      dataType: "number",
    },
    {
      key: "overtime.holiday_rate_multiplier",
      value: "2.0",
      category: "overtime",
      label: "Holiday OT Rate",
      description: "Overtime pay multiplier for work on holidays",
      dataType: "number",
    },
    {
      key: "overtime.require_approval",
      value: "true",
      category: "overtime",
      label: "Require Approval",
      description: "Require manager/admin approval for overtime entries",
      dataType: "boolean",
    },
  ];
  ...
  const tlEmployee = await prisma.employee.upsert({
  ...
  const engineeringTeam = await prisma.team.upsert({
    ...
    create: {
      ...
      teamLeaderId: tlEmployee.id,
      alternateApproverId:
        (await prisma.user.findUnique({ where: { email: "manager@team.com" } }))
          ?.employee?.id || null,
    },
  });
